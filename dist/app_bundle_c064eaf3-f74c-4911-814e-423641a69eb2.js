...
{ui_clear(6);var mdl_object=document.getElementById("ui_import_data");var mdl=new bootstrap.Modal(mdl_object,{keyboard:false,backdrop:"static"});dmdl_object.addEventListener("hidden.bs.modal",event=>{ui_clear(6);});mdl.show();};function ui_preload(is_show)
{if(is_show==true)
