...
async function on_contextmenu_item(e){e.preventDefault();var elem=e.target.closest(".ui_list_item");if(StrToBool(elem.getAttribute("is_elect"))==true){var r=await show_msg_res("Записи","Удалить запись из избранных?",true);if(r)
...
{var r=await item_set_elect(elem.getAttribute("id_item"),true);}}}
function ui_init()
...
{e.preventDefault();show_msg("Сгенерированные случайные данные",__crypt.gen_pass(100,true),true,true);};document.getElementById("ui_data_export_button").onclick=async function(e)
