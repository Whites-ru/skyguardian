...
const cacheName = "app_cache_a843ab57-e6e2-4373-ab73-290788871796"; // имя кэша приложения
...
self.addEventListener("install", (e) => {
    e.waitUntil(
        caches.open(cacheName).then((cache) => cache.addAll([
            ...
            "./app_bundle_a843ab57-e6e2-4373-ab73-290788871796.css",
            "./images/icon_any.png",
            "./images/icon_x48.png",
            "./images/icon_x72.png",
            "./images/icon_x96.png",
            ...
            "./app_bundle_a843ab57-e6e2-4373-ab73-290788871796.js"
        ])),
    );
});
